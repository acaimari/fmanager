...
<head>
    ...
    <title>Contenedor Bootstrap 4 con FileManager</title>
...
.modal-content-without-footer {
    max-height: calc(100vh - 90px); /* Ajusta este valor según tus necesidades */
    overflow-y: auto;
  }
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <button type="button" id="openFileManager" data-toggle="modal" data-target="#fileManagerModal">Seleccionar imagen</button>
        </div>
    </div>
...
<!----------------------------- MODAL ----------------------------------------->
    ...
    <div class="modal-dialog modal-lg modal-custom-height" role="document">

    <div class="modal-content d-flex flex-column modal-content-without-footer">
...
<div class="progress-bar" role="progressbar" style="width: 0%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                ...
                <div class="modal-body modal-body-scrollable flex-grow-1" style="overflow-y: auto;">
...
<!----------------------------- Arbol de directorios JS <div id="directoryContainer"> ----------------------->
<script>
$('#directories').jstree({
    'core': {
...
// Esta funcion expande todos los nodos hijos después de que un nodo se ha expandido
// $('#directories').on('after_open.jstree', function (e, data) {
//    $('#directories').jstree('open_all', data.node);
// });
...
<!--------------- File Mamager carpetas y archivos JS <table id="fileManagerContainer" class="fileManager">  -------------------------->
